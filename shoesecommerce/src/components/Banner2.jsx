    ...
    return (
        <div className='min-h-[550px] flex justify-center items-center mt-5'>
            <div className='container'>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl  bg-green-500 ">
                    ...
                    <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                        {
                            BannerData.map((data) => (
                                <div key={data.id}>
                                    ...
                                    <button className=' text-green-500 py-2 px-4 rounded bg-white  mt-2 rounded-full'>
                                        Shop Now
                                    </button>
