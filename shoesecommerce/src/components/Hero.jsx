                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2'>
                                    <div className='flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0
                                     text-center sm:text-left order-2 sm:order-1 relative z-10'>
                                        ...
                                        <h1 className='text-5xl sm:text-6xl lg:text-2xl lg:text-7xl font-bold '>{data.title}</h1>

                                        <h1 className='text-5xl uppercase text-white dark:text-white/5 sm:text-[80px]
                                         md:text-[100px] xl:text-[150px] xl:text-[150px] font-bold'>{data.title2}</h1>
                                        <div>
                                            <button className='bg-red-600 text-white cursor-pointer hover:scale-105 duration-300 py-2 px-8 rounded-full relative z-10'>Shop now</button>
                                        </div>
                                    </div>
                                    <div className='order-1 sm:order-2'>
                                        <div>
                                            <img
                                                ...
                                                drop-shadow-[-80px_4px_6px_rgba(0,0,0,.4)] relative z-40'
                                            />
                                        </div>
